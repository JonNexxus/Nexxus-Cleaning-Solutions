        ...
        <div className="flex items-start">
          ...
          {showCloseButton && (
            <div className="ml-4 flex-shrink-0 flex">
              <button
                className={`inline-flex ${styles.text} hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-${type}-50 focus:ring-${type}-600 rounded-md`}
                onClick={handleClose}
              >
